...
export default function GenerateVideoButton(props) {
  ...
  const handleGenerate = async () => {
    ...
    let scriptRes;
    try {
      scriptRes = await axios.post("http://127.0.0.1:5000/generatescript", {
        description,
    ...
    let voiceRes;
    try {
      voiceRes = await axios.post("http://127.0.0.1:5000/generateaudio", {
    ...
    try {
      const videoRes = await axios.post("http://127.0.0.1:5000/generatevideo", {
